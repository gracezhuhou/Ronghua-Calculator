    ...
    if(empty != 1) {
      ...
      switch (index) {
        ...
        case 2:
          ...
          var int = 0.1, delta = 0, pv = this.data.pv, c = this.data.c, fv = this.data.fv, n = this.data.n, most = 10;//最多循环10次
          var find = false;
          while(most > 0){
        ...
        case 3:
          ...
          var int = this.data.i, delta = 0, pv = this.data.pv, c = this.data.c, fv = this.data.fv, n = 1, most = 10;//最多循环10次
          var find = false;
          while (most) {
            delta = calPV(c, int, n, fv) - pv;
